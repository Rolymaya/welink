...
exports.KnowledgeModule = KnowledgeModule = __decorate([
    (0, common_1.Module)({
        imports: [
            (0, common_1.forwardRef)(() => super_admin_module_1.SuperAdminModule),
        ],
        ...
        exports: [knowledge_service_1.KnowledgeService, vector_store_service_1.VectorStoreService, ingestion_service_1.IngestionService],
    })
], KnowledgeModule);
