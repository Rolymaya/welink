...
var AgentController = function () {
    ...
    var AgentController = _classThis = /** @class */ (function () {
        ...
        AgentController_1.prototype.create = function (createAgentDto) {
            return this.agentService.create(createAgentDto);
        };
        AgentController_1.prototype.findAll = function (req) {
            return this.agentService.findAll(req.user.orgId);
        };
        AgentController_1.prototype.findOne = function (id) {
            return this.agentService.findOne(id);
        };
        AgentController_1.prototype.update = function (id, updateAgentDto) {
