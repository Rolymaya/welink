...
var AuthService = function () {
    ...
    var AuthService = _classThis = /** @class */ (function () {
        ...
        AuthService_1.prototype.login = function (user) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    payload = { email: user.email, sub: user.id, role: user.role, orgId: user.organizationId };
                    return [2 /*return*/, {
        ...
        AuthService_1.prototype.register = function (email_1, pass_1) {
            return __awaiter(this, arguments, void 0, function (email, pass, role) {
                var userCount, finalRole, hashedPassword, user;
                if (role === void 0) { role = client_1.Role.COMPANY_ADMIN; }
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.user.count()];
                        case 1:
                            userCount = _a.sent();
                            finalRole = userCount === 0 ? client_1.Role.SUPER_ADMIN : role;
