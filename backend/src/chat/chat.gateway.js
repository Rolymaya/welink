...
var ChatGateway = function () {
    ...
    var ChatGateway = _classThis = /** @class */ (function () {
        ...
        ChatGateway_1.prototype.handleJoinRoom = function (client, room) {
            client.join(room);
            console.log("Client ".concat(client.id, " joined room ").concat(room));
        };
        // Method to emit events to specific rooms (e.g., session ID)
        ChatGateway_1.prototype.emitToRoom = function (room, event, data) {
