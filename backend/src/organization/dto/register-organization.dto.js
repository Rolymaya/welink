...
exports.RegisterOrganizationDto = void 0;
...
var RegisterOrganizationDto = function () {
    ...
    return _a = /** @class */ (function () {
            function RegisterOrganizationDto() {
                ...
                this.sector = (__runInitializers(this, _name_extraInitializers), __runInitializers(this, _sector_initializers, void 0));
        ...
        (function () {
            ...
            _name_decorators = [(0, swagger_1.ApiProperty)({ example: 'Minha Empresa', description: 'Name of the organization' }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
            _sector_decorators = [(0, swagger_1.ApiPropertyOptional)({ example: 'E-commerce', description: 'Business sector' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _description_decorators = [(0, swagger_1.ApiPropertyOptional)({ example: 'We sell amazing products', description: 'Organization description' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
