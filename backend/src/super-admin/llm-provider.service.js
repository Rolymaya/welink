...
var LLMProviderService = function () {
    var _classDecorators = [(0, common_1.Injectable)()];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var LLMProviderService = _classThis = /** @class */ (function () {
        function LLMProviderService_1(prisma) {
            this.prisma = prisma;
        }
        LLMProviderService_1.prototype.getActiveProvider = function (preferredProvider) {
            return __awaiter(this, void 0, void 0, function () {
                var whereClause, provider;
                var _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.prisma.lLMProvider.findFirst({
                                    where: whereClause,
                                    orderBy: { priority: 'desc' },
                                })];
                        case 1:
                            provider = _b.sent();
                            if (!(!provider && preferredProvider)) return [3 /*break*/, 3];
                            return [4 /*yield*/, this.prisma.lLMProvider.findFirst({
                                    where: { isActive: true },
                                    orderBy: { priority: 'desc' },
                                })];
